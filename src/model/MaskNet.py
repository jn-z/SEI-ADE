...
class MaskExpNet(nn.Module):

    def __init__(self, args):
        super(MaskExpNet, self).__init__()
        self.nb_ref_imgs = args.mask_input_channel
        self.output_exp = args.mask_alpha

        conv_planes = [16, 32, 64, 128, 256, 256, 256]
        self.conv1 = conv(self.nb_ref_imgs, conv_planes[0], kernel_size=7)
    ...
    def forward(self, input):
        ...
        return [exp_mask1, exp_mask2, exp_mask3, exp_mask4]
